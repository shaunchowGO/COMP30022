	...
	return props.trigger ? (
		<div id="sign-up">
			<div id="top" className="login-container">
				<button className="close-btn" onClick={props.setSignUpTrigger}>
				...
				<form className="login-form" onSubmit={handleSubmit}>
					...
					<label htmlFor="id">
						Academic ID<span className="required-field">*</span>
					</label>
					<input type="text" id="aId" name="aId" placeholder="Enter your ID" required onChange={handleChange} />
