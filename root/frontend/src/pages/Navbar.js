		...
		<nav id="navbar">
			...
			<div className={`alert`}>
				<div className={`${alertValue.type}`}>
					{alertValue.text}{" "}
					{alertValue.type == "success" ? <FontAwesomeIcon icon={faCheck} /> : <FontAwesomeIcon icon={faXmark} />}
				</div>
			</div>
			<div className="nav-left">
				...
				<ul className="navs">
					...
					{props.academicID !== null ? (
						...
						<p className="nav-item" onClick={() => setLogInTrigger(!loginTrigger)}>
							Profile
						</p>
					)}
					{/* 
          {props.academicID !== null ? (
			...
			{props.academicID !== null ? (
				...
				<div className="nav-right">
					<div className="nav-right-container">
						<button className="login-btn" onClick={() => setLogInTrigger(!loginTrigger)}>
							<p>Login</p>
						</button>
						<button className="signup-btn" onClick={() => setSignUpTrigger(!signUpTrigger)}>
							<p>Sign Up</p>
						</button>
					</div>
				</div>
